...
# СООБЩЕНИЯ ОТ БОТА
start_message = """Вас приветствует магазин «RS original» 🖐
...
🌐 Телеграм чат магазина 🌐
https://t.me/+pH5qTvm7AtfdmMTUy

По решению вопросов:
Telegram: @RSmiss136666

По вопросу трудоустройства:
Jabber: rs_original@xmpp.jp
Telegram: @rs02biz
...
start_3_message = """<b>Вас приветствует магазин - RS original
Работай в RS original на лучших условиях!
